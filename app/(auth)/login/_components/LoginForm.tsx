          ...
          {!isSignUp && (
            <div className="grid grid-cols-3 gap-2">
              <Button
                ...
                disabled={isLoading}
                variant="outline"
                className="text-xs font-semibold rounded-lg border-gray-300 hover:bg-blue-50 transition-all duration-200 text-blue-600"
              >
                Demo User
              </Button>
              <Button
                ...
                disabled={isLoading}
                variant="outline"
                className="text-xs font-semibold rounded-lg border-gray-300 hover:bg-purple-50 transition-all duration-200 text-purple-600"
              >
                Demo Admin
              </Button>
              <Button
                ...
                disabled={isLoading}
                variant="outline"
                className="text-xs font-semibold rounded-lg border-gray-300 hover:bg-green-50 transition-all duration-200 text-green-600"
              >
                Demo Manager
              </Button>
            </div>
